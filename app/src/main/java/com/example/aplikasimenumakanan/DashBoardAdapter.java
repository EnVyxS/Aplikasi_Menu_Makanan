...
public class DashBoardAdapter extends RecyclerView.Adapter<DashBoardAdapter.DashBoardHolder> {
    ...
    public void onBindViewHolder(@NonNull DashBoardHolder holder, int position) {
        ...
        if(Profile.equals("FotoMakanan1")){
            holder.profile.setImageResource(R.drawable.sate);
        }
        else if(Profile.equals("FotoMakanan2")){
            holder.profile.setImageResource(R.drawable.bakso);
        }
        else if(Profile.equals("FotoMakanan3")){
            holder.profile.setImageResource(R.drawable.tahu);
        }
        else if(Profile.equals("FotoMakanan4")){
            holder.profile.setImageResource(R.drawable.nasi_ayam);
        }
        else if(Profile.equals("FotoMakanan5")){
            holder.profile.setImageResource(R.drawable.pecel_lele);
        }
